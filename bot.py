...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Start command with user status and options."""
    ...
    if user_entry["subscription"] == "free":
        message.extend([
            ...
            f"- Only {CONFIG['PLANS']['premium']['price']} EGP/month",
            "",
...
async def pay_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        f"💳 To upgrade ({CONFIG['PLANS']['premium']['price']} EGP/month):\n\n"
        "1. Send payment to Vodafone Cash: 01XXXXXXXX\n"
        "2. Forward receipt to @admin\n"
        "3. You'll be upgraded within 24 hours\n\n"
